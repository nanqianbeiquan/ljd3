...
export default {
    ...
    ini: {
        ...
        // 创建点击鼠标右键舆情时，显示公司舆情关键词词云
        createWordCloudDiv: function(styleClass, id){
            var wordCloudDiv = d3.select("body")
                .append("div")
                .attr('class', styleClass)
                .style('z-index', 1000);

            wordCloudDiv.append('div')
                .attr('id', 'wordCloudCont')
                .style('width', '200px')
                .style('height', '120px');

            wordCloudDiv.append('span')
                .attr('class', 'bot');
