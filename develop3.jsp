...
<body>
	            ...
	            <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1 sidebar" id="leftSideBar">
	                <div id="sidepanel">
	                    ...
	                    <ul>
	                    	<!-- 使用指令 v-link 进行导航。 -->
	                    	<!-- 司法分析 -->
	                    	<li id="goMain"><span class="glyphicon glyphicon-th-large" aria-hidden="true"></span></li>
	                    	<!-- 司法统计 -->
	                    	...
	                    	<li id="goBar"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span></li>
	...
	<script type="text/javascript" src="js/develop3.js"></script>
</body>
</html>